...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Button - Floating with animation */}
      <motion.button
        onClick={() => setIsMobileOpen(true)}
        className="lg:hidden fixed top-4 left-4 z-50 p-3 bg-gradient-to-br from-orange-500 to-red-500 text-white rounded-2xl shadow-lg"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        ...
        {isMobileOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed left-0 top-0 h-full w-80 bg-gradient-to-b from-white to-gray-50 z-50 shadow-2xl"
            >
              {/* Mobile Header */}
                ...
                {navigationItems.map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      <motion.div
                        className={`
                          relative flex items-center gap-4 p-4 rounded-2xl transition-all duration-200 overflow-hidden
                          ${active 
                            ? `bg-gradient-to-r ${item.bgColor} border border-gray-200 shadow-md` 
                            : 'hover:bg-gray-100/50'
                          }
                      ...
                      >
                        ...
                        {/* Active indicator */}
                        {active && (
                          <div className={`absolute left-0 w-1 h-8 bg-gradient-to-b ${item.color} rounded-r-full shadow-lg`} />
                        )}
                        ...
                        `}>
                          ...
                          <Icon className={`w-5 h-5 ${active ? 'text-white' : 'text-gray-600'} relative z-10`} />
                        </div>
